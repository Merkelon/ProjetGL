    ...
    <table class="formulaire" style="width: 360px;">
        ...
        <tr>
            ...
            <td style="width: 180px;">
                <select class="domaine" id="domaine" name="domaine" style="width: 212px;">
                    <?php
    ...
    $(document).ready(function() {
        ...
        $("input#valider_creation").click(function() {
            ...
            function(data) {
                var result = jQuery.parseJSON(data);
                if (result["message"] == "0") {
                    $("#reponse_ok").fadeIn(300).find("p").text("Entreprise ajoutée avec succés");
                    ...
                    $("div#msg_domaine").fadeIn(300).children("div.message").text(result['domaine']);
                    $("div#msg_tel ").fadeIn(300).children("div.message").text(result['tel']);
                    $("div#msg_fax ").fadeIn(300).children("div.message").text(result['fax']);
                    $("div#msg_email ").fadeIn(300).children("div.message").text(result['email']);
                    $("div#msg_ville ").fadeIn(300).children("div.message").text(result['ville']);
                    $("div#msg_adresse ").fadeIn(300).children("div.message").text(result['adresse']);
                    $("div#msg_username ").fadeIn(300).children("div.message").text(result['username']);
