...
<html>
    <head>
        ...
        <meta name="author" content="ENSAK">
            <meta name="copyright" content="ENSAK">
                <meta name="language" content="FR">
                    ...
                    <!-- Notify -->
                    <script type="text/javascript" src="<?php echo base_url(); ?>assets/javascript/notify/jquery.notify.min.js"></script>
                    <!-- FancyBox -->
                    <script type="text/javascript" src="<?php echo base_url(); ?>assets/javascript/fancybox/jquery.fancybox.js"></script>
